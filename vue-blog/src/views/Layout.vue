  ...
  <div>
    ...
    <header class="header text-center">
      <h1 class="blog-name pt-lg-4 mb-0">
        <a href="index.html">Amin's Blog</a>
      </h1>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div id="navigation" class="collapse navbar-collapse flex-column">
          <div class="profile-section pt-3 pt-lg-0">
            ...
            <div class="bio mb-3">
              Hi, my name is Amin Parchami. Briefly introduce yourself here. You
          ...
          <ul class="navbar-nav flex-column text-left">
            <li class="nav-item active">
              <a class="nav-link" href="/blog">
                <i class="fa fa-home fa-fw mr-2"></i>Blog Home
                <span class="sr-only">(current)</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/">
                <i class="fa fa-user fa-fw mr-2"></i>About Me
              </a>
            </li>
          </ul>
        </div>
...
.form-control:focus {
  ...
  border-color: #bfeac6;
  outline: 0;
  box-shadow: 0 0 0 0.2rem rgba(95, 203, 113, 0.25);
}
...
.custom-select.is-valid {
  ...
  background: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 4 5'%3e%3cpath fill='%23434242' d='M2 0L0 2h4zm0 5L0 3h4z'/%3e%3c/svg%3e")
...
.btn-primary:hover {
  color: #fff;
  background-color: #42c257;
  border-color: #3dba52;
}
.btn-primary:focus,
.btn-primary.focus {
  box-shadow: 0 0 0 0.2rem rgba(87, 179, 102, 0.5);
}
...
.btn-outline-primary.focus {
  box-shadow: 0 0 0 0.2rem rgba(95, 203, 113, 0.5);
}
...
.btn-outline-dark.focus {
  box-shadow: 0 0 0 0.2rem rgba(67, 66, 66, 0.5);
}
...
.custom-checkbox
  ...
  ~ .custom-control-label::before {
  background-color: rgba(95, 203, 113, 0.5);
}
.custom-checkbox
...
.custom-range:focus::-webkit-slider-thumb {
  box-shadow: 0 0 0 1px #fff, 0 0 0 0.2rem rgba(95, 203, 113, 0.25);
}
...
button.bg-primary:focus {
  background-color: #3dba52 !important;
}
.bg-secondary {
